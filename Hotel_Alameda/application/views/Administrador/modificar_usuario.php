<head>
  ...
  <title>Administrador Hotel Alameda -- Modificar Usuario</title>
    ...
    <div class="gc-container">
		...
		<?php endif; ?>
            <div class="col-md-12">
				...
				<form action="<?=base_url();?>index.php/Usuario/actualizar" method="post" enctype="multipart/form-data">
                <input type="hidden" name="idUsuario" value="<?=$us->idUsuario;?>"><br>
                	<div class="form-group nombreU_form_group row">
                            <label class="col-sm-3 control-label">
                                Nombre<span class="required">*</span></label>
                    	<div class="col-sm-9">
                    	<input id="field-nombreU" class="form-control" name="nombreU" type="text" value="<?=$us->nombreU;?>"  maxlength="70">                            </div>
                     </div>
                    ...
                    <div class="form-group apellidoU_form_group row">
                        ...
                        <div class="col-sm-9">
                        <input id="field-apellidoU" class="form-control" name="apellidoU" type="text" value="<?=$us->apellidoU;?>"  maxlength="70">                            </div>
                    </div>
                    ...
                    <div class="form-group telefonoU_form_group row">
                        ...
                        <div class="col-sm-9">
                    	<input id="field-telefonoU" class="form-control" name="telefonoU" type="text" value="<?=$us->telefonoU;?>"  maxlength="30">                            </div>
                    </div>
                    ...
                    <div class="form-group correoU_form_group row">
                        ...
                        Correo</label>
                    	<div class="col-sm-9">
                        <input id="field-correoU" class="form-control" name="correoU" type="text" value="<?=$us->correoU;?>"  maxlength="100">                            </div>
                    </div>
					...
					<div class="form-group correoU_form_group row">
                        ...
                        Contraseña</label>
                    	<div class="col-sm-9">
                        <input id="field-correoU" class="form-control" id="password" name="password" type="password" value="<?=$us->password;?>"  maxlength="100">                            </div>
                    </div>
